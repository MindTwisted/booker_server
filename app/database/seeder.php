...
$builderMySQL->table("{$prefix}events")
      ...
      ->values(
          ...
          ['Meeting', '2018-10-18 12:00:01', '2018-10-18 14:59:59', 2, 1, NULL, date('Y-m-d H:i:s', time() + 100000)],
          ['Meeting', '2018-09-27 10:30:01', '2018-09-27 11:29:59', 3, 1, NULL, date('Y-m-d H:i:s', time() + 109000)],
          ['Meeting', '2018-10-04 10:30:01', '2018-10-04 11:29:59', 3, 1, NULL, date('Y-m-d H:i:s', time() + 250000)],
          ['Meeting', '2018-10-11 10:30:01', '2018-10-11 11:29:59', 3, 1, NULL, date('Y-m-d H:i:s', time() + 250000)],
          ['Meeting', '2018-10-18 12:00:01', '2018-10-18 14:59:59', 3, 1, NULL, date('Y-m-d H:i:s', time() + 13000)],
          ['Meeting', '2018-10-18 09:00:01', '2018-10-18 10:59:59', 1, 3, NULL, date('Y-m-d H:i:s', time() + 102000)],
