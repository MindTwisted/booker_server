...
$builderMySQL->table("{$prefix}events")
      ...
      ->values(
          ...
          ['Meeting', '2018-10-19 09:00:00', '2018-10-19 11:00:00', 1, 2, NULL],
          ['Meeting', '2018-10-26 09:00:00', '2018-10-26 11:00:00', 1, 2, 4],
          ['Meeting', '2018-11-02 09:00:00', '2018-11-02 11:00:00', 1, 2, 4]
        )
      ->insert()
      ->run();